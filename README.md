...
> ⚠️ **下表数字已作废（2026-07-12）**：来自修正前的乐观引擎（信号日收盘成交/无涨停
> 检查/持仓估值bug/无持有期上限）。诚实引擎下 B1 v1 同期 1000 股样本年化 **-12.4%**
> （见 `reports/survivorship_bias_report.md`）。当前真实期望以
> `reports/walk_forward_*.md`（信号级 5日+5% 成功率中位 24-26%）与每晚追踪闭环为准。
